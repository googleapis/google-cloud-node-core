...
echo -e "**_THIS REPOSITORY IS DEPRECATED. ALL OF ITS CONTENT AND HISTORY HAS BEEN MOVED TO [MONOREPO-TEST](https://github.com/googleapis/google-cloud-node-core/tree/main/dev_packages/${ARTIFACT_NAME})_**\n\n$README_CONTENT" > "$README_MD"
